...
import com.apuntesdejava.salesmanager.repository.MeasurementUnitRepository;
 ...
 */
@Stateless
public class MeasurementUnitServiceImpl extends AbstractService<String, MeasurementUnit> implements MeasurementUnitService {

    @Inject
    private MeasurementUnitRepository repository;

    @Override
    protected MeasurementUnitRepository getRepository() {
        return repository;
    }
}
