...
import com.apuntesdejava.salesmanager.repository.StorehouseRepository;
 ...
 */
@Stateless
public class StorehouseServiceImpl extends AbstractService<Long, Storehouse> implements StorehouseService {

    @Inject
    private StorehouseRepository storehouseRepository;

    @Override
    protected StorehouseRepository getRepository() {
