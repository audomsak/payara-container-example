...
public interface ProductMovementService {
    ...
    ProductMovement create(Product product, double count, ProductMovementType type, double unitPrice, Storehouse storeHouse, String comment);

    List<ProductMovement> listByProduct(Product p);
}
